            ...
            <div class="col-md-8 col-md-offset-2">
                ...
                <div class="box box-solid box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div>
                            <table id="itemList" class="table table-striped table-bordered table-hover" cellspacing="0"
                                   width="100%">
                                <thead>
                                <tr>
                                    <th>Barcode</th>
                ...
                <div class="box box-solid box-default collapsed-box">
                    ...
                    <div class="box-body">
                        ...
                        <div>
                            <table id="deletedItemsList" class="table table-striped table-bordered table-hover"
                                   cellspacing="0"
                                   width="100%">
                                <thead>
                                <tr>
